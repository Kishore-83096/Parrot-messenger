...
from .views import (
    ...
    update_receipt_visibility_cache,
    update_direct_room_list_visibility,
...
urlpatterns = [
    ...
    path('receipts/internal/visibility-cache/', update_receipt_visibility_cache, name='receipt-visibility-cache'),
    path('rooms/internal/direct-visibility/', update_direct_room_list_visibility, name='direct-room-list-visibility'),
