...
MESSAGING_AUTHORIZATION_CACHE_TTL_SECONDS = int(os.getenv('MESSAGING_AUTHORIZATION_CACHE_TTL_SECONDS', '600'))
MESSAGING_RECEIPT_VISIBILITY_CACHE_TTL_SECONDS = int(os.getenv('MESSAGING_RECEIPT_VISIBILITY_CACHE_TTL_SECONDS', '600'))
MESSAGING_TYPING_TTL_SECONDS = int(os.getenv('MESSAGING_TYPING_TTL_SECONDS', '7'))
MESSAGING_PRESENCE_TTL_SECONDS = int(os.getenv('MESSAGING_PRESENCE_TTL_SECONDS', '60'))
...
CLOUDINARY_MAIN_FOLDER = os.getenv('CLOUDINARY_MAIN_FOLDER', 'Parrot').strip('/') or 'Parrot'
MESSAGING_MAX_UPLOAD_FILE_SIZE_BYTES = int(os.getenv('MESSAGING_MAX_UPLOAD_FILE_SIZE_BYTES', str(25 * 1024 * 1024)))
